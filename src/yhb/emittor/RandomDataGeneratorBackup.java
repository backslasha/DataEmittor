...
public class RandomDataGeneratorBackup {
    ...
    public String[] generateValues(String[] methodNames, String[] methodParamsStringArray) {
        ...
        Class<RandomDataGeneratorBackup> clazz = RandomDataGeneratorBackup.class;
        ...
        for (int i = 0; i < methodNames.length; i++) {
            ...
            try {
                ...
                if (methodName.equals("enums")) {
                    value = (String) method.invoke(RandomDataGeneratorBackup.this, new Object[]{methodParams});
                } else {
                    value = (String) method.invoke(RandomDataGeneratorBackup.this, methodParams);
                }
 ...
 */
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 10; i++) {
            System.out.println(new RandomDataGeneratorBackup().enums("sajijai", "jsaoijoas", "iajsihiuefb"));
        }
    }

    public static void printMethods() {
        Class clazz = RandomDataGeneratorBackup.class;
